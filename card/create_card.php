...
<html lang="de">
<body>
    <form method="post" accept-charset="UTF-8" action="card/create_card_logic.php" class="form-container" style="max-width: 400px; margin: auto;">
    ...
    <script>
        async function fetchSongInfo() {
            ...
            if (link.includes("dzr.page.link/")) {
                ...
                if (finalUrl.includes("deezer.com/track/")) {
                    ...
                    const resTrack = await fetch(`proxy/deezer_proxy.php?id=${trackId}`);
        ...
        async function fetchPlaylistInfo() {
            ...
            const res = await fetch(`../proxy/${platform}_playlist_proxy.php?id=${playlistId}`);
            const data = await res.json();
